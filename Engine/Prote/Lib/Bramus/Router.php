...
// Return the number of rhttp://dev.vtuacademy.com/asdfoutes handled
return $numHandled;
...
//COMMENT OUT BELOW CODE IF RUNNING ON APACHE WITH REWRITE OPTIONS IN .htaccess as :
/*
RewriteEngine On
...
*/
//Code for apache rewrite engine

$basepath = implode('/', array_slice(explode('/', $_SERVER['SCRIPT_NAME']), 0, -1)) . '/';
$uri = substr($_SERVER['REQUEST_URI'], strlen($basepath));

//Simple REQUEST URI works just fine for enginx try_files and rewrite
$uri=$_SERVER['REQUEST_URI'];

//Code below Common for all rewrite engines.
